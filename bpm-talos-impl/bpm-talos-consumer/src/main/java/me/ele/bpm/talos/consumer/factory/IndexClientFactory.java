package me.ele.bpm.talos.consumer.factory;
...
import me.ele.bpm.talos.consumer.model.EsClientConf;
import me.ele.bpm.talos.consumer.model.EsClientNode;
...
public class IndexClientFactory {
	...
	static {
		try {
			String esclientStr = HuskarHandle.get().getMyConfig().getProperty("ESCLIENT");
			EsClientConf esClientConf = JsonHelper.getMapper().readValue(esclientStr, EsClientConf.class);
